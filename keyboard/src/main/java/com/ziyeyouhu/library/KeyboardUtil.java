...
import com.ziyeyouhu.library.PpKeyBoardView.KeyModel;
...
//				WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
    ...
    public void hideSystemKeyBoard() {
        @SuppressLint("WrongConstant") InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
...
//				return;
    ...
    private void initKeyBoard(int keyBoardViewID) {
        ...
        if (inflaterView != null) {
            ...
            keyboardView = (PpKeyBoardView) mActivity.findViewById(keyBoardViewID);
        }
//        keyboardView = (PpKeyBoardView) mActivity.findViewById(keyBoardViewID);
...
//        }
        ...
        if (inputType == INPUTTYPE_NUM_ABC) {
            initKeyBoard(R.id.keyboard_view);
            keyboardView.setPreviewEnabled(false);
            numKeyboard = new Keyboard(mContext, R.xml.symbols_num_abc);
            randomdigkey(numKeyboard);
     ...
     */
    //新的show方法
    public void showKeyBoardLayoutChange(final EditText editText, int keyBoardType, int scrollTo) {
        if (editText.equals(ed) && getKeyboardState() && inputType == keyBoardType)
            return;
    ...
    private void randomdigkey(Keyboard mKeyboard) {
        ...
        ArrayList<KeyModel> resultList = new ArrayList<>();
    ...
    private void randomalpkey(Keyboard mKeyboard) {
        ...
        temp.add(new KeyModel(122, "" + (char) 122));// .
        // 取数
